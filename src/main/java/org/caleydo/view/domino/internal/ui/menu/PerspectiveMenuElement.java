 ...
 *******************************************************************************/
package org.caleydo.view.domino.internal.ui.menu;

import static org.caleydo.view.domino.internal.Settings.TOOLBAR_WIDTH;
import static org.caleydo.view.domino.internal.Settings.toolbarBackground;
...
public class PerspectiveMenuElement extends GLElementContainer {
	...
	protected final DominoLayoutInfo getInfo() {
		return getParent().getLayoutDataAs(DominoLayoutInfo.class, null);
	}
