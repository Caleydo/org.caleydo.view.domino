 ...
 *
 */
public class DragSelectionInfoButton extends AGLButton implements IDragGLSource {

	private final SelectionManager manager;
	private boolean dragMode = true;

	public DragSelectionInfoButton(SelectionManager manager) {
		this.manager =manager;
		setRenderer(GLRenderers.fillImage(Resources.ICON_MISSING));
		setTooltip("Show / Hide Selection Info for " + getLabel());
	}
