 ...
 *
 */
public class DominoElement extends AnimatedGLElementContainer implements
	...
	public DominoElement(TablePerspective tablePerspective, TablePerspectiveMetaData metaData, ElementConfig config) {
		this(tablePerspective, metaData, config, null);
	}

	public DominoElement(TablePerspective tablePerspective, TablePerspectiveMetaData metaData, ElementConfig config,
			DominoElement parent) {
		this.selection = new TablePerspectiveSelectionMixin(tablePerspective, this);
		this.info = new DominoLayoutInfo(this, config);
	...
	public void onVAUpdate(TablePerspective tablePerspective) {
		...
		DominoMultiElement p = getMultiElement();
		if (p != null)
	...
	public void onSelectionChanged(GLButton button, boolean selected) {
		DominoMultiElement parent = getMultiElement();
